...
export class blockPassCreated extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save blockPassCreated entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type blockPassCreated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("blockPassCreated", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): blockPassCreated | null {
    return changetype<blockPassCreated | null>(
      store.get_in_block("blockPassCreated", id.toHexString()),
    );
  }

  static load(id: Bytes): blockPassCreated | null {
    return changetype<blockPassCreated | null>(
      store.get("blockPassCreated", id.toHexString()),
    );
  }
  ...
  get blockPassId(): BigInt {
    let value = this.get("blockPassId");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set blockPassId(value: BigInt) {
    this.set("blockPassId", Value.fromBigInt(value));
  }
...
export class passBooked extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save passBooked entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type passBooked must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("passBooked", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): passBooked | null {
    return changetype<passBooked | null>(
      store.get_in_block("passBooked", id.toHexString()),
    );
  }

  static load(id: Bytes): passBooked | null {
    return changetype<passBooked | null>(
      store.get("passBooked", id.toHexString()),
    );
  }
